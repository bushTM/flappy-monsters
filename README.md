...
git clone https://github.com/bushTM/flappy-monsters
cd flappy-monsters

# Create and activate a virtual environment
python -m venv venv

(Note: Python version 3.14 not compatible with pygame at the time of completion of this project, so version 3.11 was used. )

# To make a virtual enviroment, using a specific version of python:
py -3.11 -m venv venv
